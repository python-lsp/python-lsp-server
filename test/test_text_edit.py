...
def test_apply_text_edits_insert(pylsp):
    ...
    assert (
        apply_text_edits(
            test_doc,
            [{"range": {"start": {"line": 0, "character": 1}, "end": {"line": 0, "character": 1}}, "newText": "Hello"}],
        )
    ...
    assert (
        apply_text_edits(
            test_doc,
            [
                {"range": {"start": {"line": 0, "character": 2}, "end": {"line": 0, "character": 2}}, "newText": "One"},
                {
                    "range": {"start": {"line": 0, "character": 1}, "end": {"line": 0, "character": 1}},
                    "newText": "Hello",
                },
                ...
                {"range": {"start": {"line": 0, "character": 2}, "end": {"line": 0, "character": 2}}, "newText": "Two"},
                {
...
def test_apply_text_edits_replace(pylsp):
    ...
    assert (
        apply_text_edits(
            test_doc,
            [{"range": {"start": {"line": 0, "character": 3}, "end": {"line": 0, "character": 6}}, "newText": "Hello"}],
        )
