...
TYPE_CASES: Dict[str, TypeCase] = {
    ...
    "keyword": TypeCase(
        document="fro", position={"line": 0, "character": 3}, label="from", expected=lsp.CompletionItemKind.Keyword
    ),
    "file": TypeCase(
    ...
    "class": TypeCase(
        document="KeyErr", position={"line": 0, "character": 6}, label="KeyError", expected=lsp.CompletionItemKind.Class
    ),
    "property": TypeCase(
        document=("class A:\n" "    @property\n" "    def test(self):\n" "        pass\n" "A().tes"),
...
def test_jedi_completion_item_resolve(config, workspace):
    ...
    expected_doc = {"kind": "markdown", "value": "```python\ndocumented_hello()\n```\n\n\nSends a polite greeting"}
