...
def test_definitions(config, workspace):
    ...
    # The definition of 'a'
    def_range = {"start": {"line": 0, "character": 4}, "end": {"line": 0, "character": 5}}
...
def test_assignment(config, workspace):
    ...
    def_range = {"start": {"line": 8, "character": 13}, "end": {"line": 8, "character": 20}}
...
"""
    ...
    def_range = {"start": {"line": 1, "character": 4}, "end": {"line": 1, "character": 7}}
